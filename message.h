...
typedef enum type_of_message {random_access_request, random_access_response, rrc_request, rrc_setup, rrc_complete, ue_battery_low, ue_battery_high, ping, pong, ue_off, enb_off, signal_request, signal_response} e_message_type;
